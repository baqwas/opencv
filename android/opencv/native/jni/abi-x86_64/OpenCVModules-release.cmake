...
set_target_properties(ipphal PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/sdk/native/3rdparty/libs/x86_64/libipphal.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS ipphal )
list(APPEND _IMPORT_CHECK_FILES_FOR_ipphal "${_IMPORT_PREFIX}/sdk/native/3rdparty/libs/x86_64/libipphal.a" )
...
set_target_properties(opencv_geometry PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/sdk/native/staticlibs/x86_64/libopencv_geometry.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_geometry )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_geometry "${_IMPORT_PREFIX}/sdk/native/staticlibs/x86_64/libopencv_geometry.a" )
...
set_target_properties(opencv_ptcloud PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/sdk/native/staticlibs/x86_64/libopencv_ptcloud.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_ptcloud )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_ptcloud "${_IMPORT_PREFIX}/sdk/native/staticlibs/x86_64/libopencv_ptcloud.a" )
...
set_target_properties(opencv_features PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/sdk/native/staticlibs/x86_64/libopencv_features.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_features )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_features "${_IMPORT_PREFIX}/sdk/native/staticlibs/x86_64/libopencv_features.a" )
...
set_target_properties(opencv_calib PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/sdk/native/staticlibs/x86_64/libopencv_calib.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_calib )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_calib "${_IMPORT_PREFIX}/sdk/native/staticlibs/x86_64/libopencv_calib.a" )
...
set_target_properties(opencv_java PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/sdk/native/libs/x86_64/libopencv_java5.so"
  IMPORTED_SONAME_RELEASE "libopencv_java5.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_java )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_java "${_IMPORT_PREFIX}/sdk/native/libs/x86_64/libopencv_java5.so" )
